                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PatientProgress()),
                    );
                  },
                ),
                ListTile(
                              ...
                              Card(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    Ink.image(
                                      image:
                                          AssetImage('assets/prescription.jpg'),
                                      width: double.infinity,
                                      height: 200,
                                      colorFilter: new ColorFilter.mode(
                            ...
                            children: [
                              Card(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    Ink.image(
                                      image: AssetImage('assets/feedback2.png'),
                                      width: double.infinity,
                                      height: 200,
                                      colorFilter: new ColorFilter.mode(
                                          Colors.black.withOpacity(0.5),
                      ...
                      Expanded(
                        child: IconButton(
                          ...
                          onPressed: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: Text('No activity practiced!')));
                          },
                        ),
                      ),
                      Expanded(
